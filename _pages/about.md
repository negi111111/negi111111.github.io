...
3. **プロセスデータおよび炉内映像Optical-Flowに基づくマルチモーダル深層学習によるごみ焼却プラントの蒸気量推定**  
...
18. **ConvDeconvNetの効率的モバイル実装による画像変換・物体検出・領域分割リアルタイムiOSアプリ群**  
...
- **Certified Scrum Developer® (CSD®)**<br>
  Scrum Alliance  
